# Let's create the system with correct formatting
...
directories = ['src/models', 'src/data', 'src/utils', 'src/dashboard', 'data', 'models_saved', 'config']
for directory in directories:
    os.makedirs(directory, exist_ok=True)

print("✓ Project structure created")

# Create a simplified but comprehensive credit model
...
print("\nSystem architecture completed successfully!")